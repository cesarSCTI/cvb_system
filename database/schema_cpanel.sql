...
-- Esquema de base de datos — variante para cPanel / hosting compartido
--
-- Diferencia con schema.sql: NO incluye "CREATE DATABASE" ni "USE",
-- porque en cPanel la base de datos ya la creas tú desde
-- "MySQL® Databases" (con el prefijo de tu cuenta, ej. usuario_cvb) y
-- phpMyAdmin importa siempre dentro de la base que tengas seleccionada.
-- Usa este archivo en lugar de schema.sql al migrar a un hosting cPanel.
-- ===========================================
